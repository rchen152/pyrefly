...
[command-line tool](https://pyrefly.org/en/docs/installation/), 
[VSCode extension](https://marketplace.visualstudio.com/items?itemName=meta.pyrefly), and a 
[Zed extension](https://zed.dev/extensions/pyrefly).
