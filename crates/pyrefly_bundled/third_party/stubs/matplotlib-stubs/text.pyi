...
class Text(Artist):
    ...
    def set_verticalalignment(
        self,
        align: Literal["bottom", "baseline", "center", "center_baseline", "top"],
    ) -> None: ...
    def set_text(self, s) -> None: ...
    def set_fontproperties(
        self,
        fp: str | pathlib.Path | PosixPath | FontProperties,
    ) -> None: ...
...
class Annotation(Text, _AnnotationBase):
    ...
    def set_anncoords(
        self,
        coords: str | Artist | Transform | Callable | Sequence[float],
    ): ...
    anncoords = ...
