...
class Axis(Artist):
    ...
    def get_ticklabels(
        self,
        minor: bool = ...,
        which: None | Literal["minor", "major", "both"] = ...,
    ) -> list[Text]: ...
    ...
    def set_units(self, u: None | timezone | float) -> None: ...
    def get_units(self) -> None | timezone | float: ...
...
class XAxis(Axis):
    ...
    def set_ticks_position(
        self,
        position: Literal["top", "bottom", "both", "default", "none"],
    ) -> None: ...
