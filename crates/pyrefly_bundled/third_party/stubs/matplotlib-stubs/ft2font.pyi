...
class FT2Font:
    ...
    def select_charmap(self, i) -> typing.Any:
        r"""Select a charmap by its FT_Encoding number.\n."""

    def set_charmap(self, i) -> typing.Any:
        r"""Make the i-th charmap current.\n."""

    def set_size(self, ptsize, dpi) -> typing.Any:
        r"""Set the point size and dpi of the text.\n."""

    def set_text(self, string, angle, flags) -> typing.Any:
        r"""Set the text *string* and *angle*.\n*flags* can be a bitwise-or of the LOAD_XXX constants;\nthe default value is LOAD_FORCE_AUTOHINT.\nYou must call this before `.draw_glyphs_to_bitmap`.\nA sequence of x,y positions is returned.\n."""
...
class FT2Image:
    ...
    def draw_rect(self, x0, y0, x1, y1) -> typing.Any:
        r"""Draw an empty rectangle to the image.\n."""

    def draw_rect_filled(self, x0, y0, x1, y1) -> typing.Any:
        r"""Draw a filled rectangle to the image.\n."""
