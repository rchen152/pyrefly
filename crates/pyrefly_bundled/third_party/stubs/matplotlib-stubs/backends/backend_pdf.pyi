...
class PdfFile:
    def __init__(
        self,
        filename: BytesIO | str | PathLike | FileLike,
    ...
    def beginStream(
        ...
        id: int,
        len: None | Reference,
        extra: None | dict[str, int | Name] | dict[str, Name | list[int]] | dict[str, Name | int | Verbatim] | dict[str, Name | int | Verbatim | Reference] = ...,
...
class GraphicsContextPdf(GraphicsContextBase):
    ...
    def hatch_cmd(
        self,
        hatch: None,
        hatch_color: tuple[float, float, float, float],
    ) -> list[Name | Op | float]: ...
    def rgb_cmd(
        self,
